...
&lt;br /&gt;&lt;b&gt;Notes:&lt;/b&gt; &lt;ul&gt;&lt;li&gt;Any characters in the pattern that are not in the ranges of [&apos;a&apos;..&apos;z&apos;] and [&apos;A&apos;..&apos;Z&apos;] will be treated as quoted text. For instance, characters like &apos;:&apos;, &apos;.&apos;, &apos; &apos;, &apos;#&apos; and &apos;@&apos; will appear in the resulting time text even they are not enclosed within single quotes.The single quote is used to &apos;escape&apos; letters. Two single quotes in a row, whether inside or outside a quoted sequence, represent a &apos;real&apos; single quote.&lt;/li&gt;&lt;li&gt;Minimal update interval is 1 second. If z or zzz is configured time is shown with the milliseconds fraction, but not updated on millisecond basis (avoiding big performance hit).&lt;/li&gt;&lt;ul&gt;
        ...
        <translation type="vanished">&lt;h1&gt;Syntaxe du format Date/Heure&lt;/h1&gt;
&lt;p&gt;Un motif de date est une chaîne de caractères où les caractères spécifiques sont remplacés par les données de date et d&apos;heure d&apos;un calendrier lors du formatage ou utilisées pour générer des données pour un calendrier lors de l&apos;analyse.&lt;/p&gt;
&lt;p&gt;Le tableau Champ-Date-Symbole ci-dessous contient les caractères utilisés dans les modèles pour montrer les formats appropriés pour un endroit donné, comme aaaa pour l&apos;année. Les caractères peuvent être utilisés plusieurs fois. Par exemple, si y est utilisé pour l&apos;année, &apos;yy&apos; pourrait produire «99», alors que «yyyy» produit «1999». Pour la plupart des champs numériques, le nombre de caractères spécifie la largeur du champ. Par exemple, si h est l&apos;heure, &apos;h&apos; pourrait produire &apos;5&apos;, mais &apos;hh&apos; produit &apos;05&apos;. Pour certains caractères, le nombre spécifie si une forme abrégée ou complète doit être utilisée, mais peut avoir d&apos;autres choix, comme indiqué ci-dessous.&lt;/p&gt;
&lt;p&gt;Deux guillemets simples représentent une apostrophe, tant à l&apos;intérieur qu&apos;à l&apos;extérieur des guillemets simples. Les textes entre guillemets simples ne sont jamais interprétés (sauf pour les deux guillemets simples adjacents). En dehors des guillemets simples, toutes les lettres ASCII de a à z et de A à Z sont considérées comme caractères de syntaxe, et nécessitent donc des guillemets simples pour représenter les caractères littéraux. En outre, certains caractères ASCII de ponctuation peuvent devenir variable dans le futur (par exemple &quot;:&quot; est interprété comme séparateur de temps et &apos;/&apos; comme séparateur de date, et peuvent être remplacés par des caractères régionaux lors de l&apos;affichage).&lt;br /&gt;&lt;/p&gt;
&lt;table border=&quot;1&quot; width=&quot;100%&quot; cellpadding=&quot;4&quot; cellspacing=&quot;0&quot;&gt;
&lt;tr&gt;&lt;th width=&quot;20%&quot;&gt;Code&lt;/th&gt;&lt;th&gt;Signification&lt;/th&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;d&lt;/td&gt;&lt;td&gt;le jour du mois, sous la forme d&apos;un nombre sans zéro (1 to 31)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;dd&lt;/td&gt;&lt;td&gt;le jour du mois, sous la forme d&apos;un nombre avec zéro (01 to 31)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;ddd&lt;/td&gt;&lt;td&gt;l&apos;abréviation locale du jour de la semaine (ex. &apos;Lun&apos; à &apos;Dim&apos;).&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;dddd&lt;/td&gt;&lt;td&gt;le nom local complet du jour de la semaine (ex. &apos;Lundi&apos; à &apos;Dimanche&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;M&lt;/td&gt;&lt;td&gt;le mois, sous la forme d&apos;un nombre sans zéro (1-12)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;MM&lt;/td&gt;&lt;td&gt;le mois, sous la forme d&apos;un nombre avec zéro (01-12)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;MMM&lt;/td&gt;&lt;td&gt;l&apos;abréviation locale du mois (ex. &apos;Jan&apos; à &apos;Déc&apos;).&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;MMMM&lt;/td&gt;&lt;td&gt;le nom local complet du mois (e.g. &apos;Janvier&apos; to &apos;Décembre&apos;).&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;yy&lt;/td&gt;&lt;td&gt;l&apos;année, sous la forme d&apos;un nombre à 2 digits (00-99)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;yyyy&lt;/td&gt;&lt;td&gt;l&apos;année, sous la forme d&apos;un nombre à 4 digitsr&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;h&lt;/td&gt;&lt;td&gt;l&apos;heure sans zéro (0 à 23 ou 1 à 12 avec affichage AM/PM)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;hh&lt;/td&gt;&lt;td&gt;l&apos;heure avec zéro (00 à 23 ou 01 à 12 avec affichage AM/PM)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;H&lt;/td&gt;&lt;td&gt;l&apos;heure sans zéro (0 à 23, même avec affichage AM/PM)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;HH&lt;/td&gt;&lt;td&gt;l&apos;heure avec zéro (00 à 23, même avec affichage AM/PM)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;m&lt;/td&gt;&lt;td&gt;les minutes sans zéro (0 à 59)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;mm&lt;/td&gt;&lt;td&gt;les minutes avec zéro (00 à 59)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;s&lt;/td&gt;&lt;td&gt;les secondes sans zéro (0 ào 59)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;ss&lt;/td&gt;&lt;td&gt;les secondes avec zéro (00 à 59)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;z&lt;/td&gt;&lt;td&gt;les millisecondes sans zéro (0 à 999)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;zzz&lt;/td&gt;&lt;td&gt;les millisecondes avec zéro (000 ào 999)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;AP &lt;i&gt;ou&lt;/i&gt; A&lt;/td&gt;&lt;td&gt;utiliser l&apos;affichage AM/PM. &lt;b&gt;A/AP&lt;/b&gt; sera remplacé par &quot;AM&quot; ou &quot;PM&quot;.&lt;&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;ap &lt;i&gt;ou&lt;/i&gt; a&lt;/td&gt;&lt;td&gt;utiliser l&apos;affichage am/pm. &lt;b&gt;a/ap&lt;/b&gt; sera remplacé par &quot;am&quot; ou &quot;pm&quot;.&lt;&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;t&lt;/td&gt;&lt;td&gt;le fuseau horaire (example &quot;CEST&quot;)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;T&lt;/td&gt;&lt;td&gt;le décalage par rapport à UTC&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;TT&lt;/td&gt;&lt;td&gt;le fuseau horaire IANA id&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;TTT&lt;/td&gt;&lt;td&gt;l&apos;abréviation du fuseau horaire&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;TTTT&lt;/td&gt;&lt;td&gt;le nom court du fuseau horaire&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;TTTTT&lt;/td&gt;&lt;td&gt;le nom long du fuseau horaire&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;TTTTTT&lt;/td&gt;&lt;td&gt;le nom personnalisé du fuseau horaire. Vous pouvez le changer dans l&apos;onglet &apos;Fuseaux horaires&apos; de la fenêtre de configuration.&gt;&lt;/tr&gt;&lt;/table&gt;
&lt;p&gt;&lt;br /&gt;&lt;b&gt;Note :&lt;/b&gt; Tout caractère (du motif) qui n&apos;appartient pas à [&apos;a&apos;..&apos;z&apos;] ou [&apos;A&apos;..&apos;Z&apos;] sera traité comme étant entre &apos;&apos;. Par exemple, des caractèrs tels que &apos;:&apos;, &apos;.&apos;, &apos; &apos;, &apos;#&apos; et &apos;@&apos; vont apparaître comme du texte dans l&apos;horloge même s&apos;ils ne sont pas entourés de guillemets simples.Les guillemets simples sont utilisés pour &apos;échapper&apos; des lettres. Deux quillemets simples dans une colonne (à l&apos;intérieur comme à l&apos;extérieur d&apos;une citation) représentent un guillemet simple réel (apostrophe).&lt;/p&gt;
</translation>
    </message>
</context>
<context>
