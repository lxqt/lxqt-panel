...
&lt;br /&gt;&lt;b&gt;Notes:&lt;/b&gt; &lt;ul&gt;&lt;li&gt;Any characters in the pattern that are not in the ranges of [&apos;a&apos;..&apos;z&apos;] and [&apos;A&apos;..&apos;Z&apos;] will be treated as quoted text. For instance, characters like &apos;:&apos;, &apos;.&apos;, &apos; &apos;, &apos;#&apos; and &apos;@&apos; will appear in the resulting time text even they are not enclosed within single quotes.The single quote is used to &apos;escape&apos; letters. Two single quotes in a row, whether inside or outside a quoted sequence, represent a &apos;real&apos; single quote.&lt;/li&gt;&lt;li&gt;Minimal update interval is 1 second. If z or zzz is configured time is shown with the milliseconds fraction, but not updated on millisecond basis (avoiding big performance hit).&lt;/li&gt;&lt;ul&gt;
        ...
        <translation type="vanished">&lt;h1&gt;Синтаксис своего формата даты/времени&lt;/h1&gt;
...
&lt;p&gt;Таблица символов полей даты ниже содержит символы, используемые в шаблонах для отображения подходящих форматов установленной локали, такой как yyyy для года. Символы могут быть использованы несколько раз. Например, если использован y для года, &apos;yy&apos; отобразит &apos;99&apos;, тогда как &apos;yyyy&apos; покажет &apos;1999&apos;. Для большинства числовых полей число символов определяет ширину поля. Например, если h это час, &apos;h&apos; отобразит &apos;5&apos;, но &apos;hh&apos; отобразит &apos;05&apos;. Для некоторых символов, это число определяет должно ли быть использовано сокращение или полная форма, но могут быть и другие варианты, как написано ниже.&lt;/p&gt;
&lt;p&gt;Две одинарные кавычки отобразят одиночную кавычку, независимо от того внутренние они или внешние. Текст внутри одинарных кавычек никак не интерпретируется (за исключением двух смежных одинарных кавычек). Тогда как все символы ASCII от a до z и A до Z зарезервированы под символы синтаксиса, и требуют заключения в кавычки для отображения их как обычных символов. помимо прочего, некоторые знаки препинания ASCII могут стать переменными в будущем (т.е.&quot;:&quot; быть интерпретированы как разделитель компонентов времени и &apos;/&apos; как разделитель компонентов даты, и заменены при отображении соответствующими символами с учётом локали).&lt;br /&gt;&lt;/p&gt;
&lt;table border=&quot;1&quot; width=&quot;100%&quot; cellpadding=&quot;4&quot; cellspacing=&quot;0&quot;&gt;
...
&lt;tr&gt;&lt;td&gt;ddd&lt;/td&gt;&lt;td&gt;сокращённое локализованное название дня (т.е. от &apos;Пн&apos; до &apos;Вс&apos;).&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;dddd&lt;/td&gt;&lt;td&gt;длинное локализованное название дня (т.е. от &apos;Понедельник&apos; до &apos;Воскресенье&apos;&lt;/td&gt;&lt;/tr&gt;
...
&lt;tr&gt;&lt;td&gt;AP &lt;i&gt;или&lt;/i&gt; A&lt;/td&gt;&lt;td&gt;использовать отображение AM/PM. &lt;b&gt;A/AP&lt;/b&gt; будет замещено на &quot;AM&quot; или &quot;PM&quot;.&lt;&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;ap &lt;i&gt;или&lt;/i&gt; a&lt;/td&gt;&lt;td&gt;использовать отображение am/pm. &lt;b&gt;a/ap&lt;/b&gt; будет замещено на &quot;am&quot; или &quot;pm&quot;.&lt;&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;t&lt;/td&gt;&lt;td&gt;часовой пояс (например &quot;CEST&quot;)&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;T&lt;/td&gt;&lt;td&gt;сдвиг времени относительно UTC&lt;/td&gt;&lt;/tr&gt;
...
&lt;tr&gt;&lt;td&gt;TTTTT&lt;/p&gt;&lt;/td&gt;&lt;td&gt;&lt;p&gt;длинное имя часового пояса&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;td&gt;TTTTTT&lt;/td&gt;&lt;td&gt;своё имя часового пояса. Вы можете изменить его во вкладке «Часовые пояса» окна настройки&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;
&lt;br /&gt;&lt;b&gt;Замечание:&lt;/b&gt; &lt;ul&gt;&lt;li&gt; Любые символы в шаблоне не из диапазона [&apos;a&apos;..&apos;z&apos;] и [&apos;A&apos;..&apos;Z&apos;] будут обработаны как цитируемый текст. Например, символы как &apos;:&apos;, &apos;.&apos;, &apos; &apos;, &apos;#&apos; и &apos;@&apos; появятся в тексте со временем, даже если они не помещены в одинарные кавычки. Одинарные кавычки используются для управляющих символ. Две одинарные кавычки подряд, независимо от того внутри или снаружи цитируемой последовательности, представляет &apos;реальные&apos; одинарные кавычки.&lt;/li&gt;&lt;li&gt;Наименьший интервал обновления 1 секунда. Если для отображения времени используется z или zzz, оно показывается с миллисекундами, но не обновляется каждую миллисекунду (чтобы избежать большого падения производительности).&lt;/li&gt;&lt;ul&gt;</translation>
    </message>
</context>
<context>
