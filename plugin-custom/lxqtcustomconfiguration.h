...
#ifndef LXQTCUSTOMCONFIGURATION_H
#define LXQTCUSTOMCONFIGURATION_H

#include "../panel/lxqtpanelpluginconfigdialog.h"
#include "../panel/pluginsettings.h"

namespace Ui {
    class LXQtCustomConfiguration;
}

class LXQtCustomConfiguration : public LXQtPanelPluginConfigDialog
{
    Q_OBJECT

public:
    explicit LXQtCustomConfiguration(PluginSettings *settings, QWidget *parent = nullptr);
    ~LXQtCustomConfiguration();
...
private:
    Ui::LXQtCustomConfiguration *ui;
};

#endif // LXQTCUSTOMCONFIGURATION_H
