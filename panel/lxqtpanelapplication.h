...
public:
    ...
    /*!
     * \brief Returns the LXQt::Settings object that is used for the
     * current instance of lxqt-panel. This can be used by the LXQtPanel
     * instances.
     * \return the LXQt::Settings object of the current lxqt-panel instance
     */
