...
public:
     ...
     * @return Returns the position where the panel is located.
     */
     ...
     * @return The edge length of the icons in pixels.
     */
    virtual int iconSize() const = 0;
    /**
     * @brief Returns the number of lines/rows of this panel.
     * @return The number of lines/rows of this panel.
     */
    virtual int lineCount() const = 0;

    /**
     * @brief Helper functions for convenient direction/alignment checking.
     * @return Retuns true if the panel is on the top or the bottom of the
